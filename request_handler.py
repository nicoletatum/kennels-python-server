...
from customers.request import get_all_customers, get_customers_by_email, get_single_customer, create_customer, delete_customer, update_customer
...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # the orange squiggle, you'll define the create_object
        # function next.
        if resource == "animals":
